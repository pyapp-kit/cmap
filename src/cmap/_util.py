...
def report(cm: Colormap, n: int = 256, uniform_space: str = "CAM02-UCS", initial_space= "sRGB1") -> Dict[str, ReportDict]:
...
def report_cvds(cm: Colormap, n: int = 256, uniform_space: str = "CAM02-UCS") -> CVDReportDict:
    ...
    return {
        ...
        "protan": report(cm, n=n, uniform_space=uniform_space, initial_space={"name":"sRGB1+CVD", "cvd_type": "protanomaly", "severity": 100}),
        "deutan": report(cm, n=n, uniform_space=uniform_space, initial_space={"name":"sRGB1+CVD", "cvd_type": "deuteranomaly", "severity": 100}),
        "tritan": report(cm, n=n, uniform_space=uniform_space, initial_space={"name":"sRGB1+CVD", "cvd_type": "tritanomaly", "severity": 100}),
    }
